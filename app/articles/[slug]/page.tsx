  ...
  return (
    <PublicShell>
      <article className="mesh-bg section max-w-4xl">
        ...
        <h1 className="gradient-text mt-4 text-4xl font-bold">{article.titre}</h1>
        <div className="mt-10 whitespace-pre-line text-lg leading-8 text-slatecopy">{article.contenu}</div>
      </article>
    </PublicShell>
  );
}
